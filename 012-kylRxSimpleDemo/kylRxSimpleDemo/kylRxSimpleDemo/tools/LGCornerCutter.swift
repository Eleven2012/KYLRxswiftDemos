...
extension UIView {
    ...
    func lg_roundCorner(cornerRadii: CGFloat)  {
        
        self.lg_roundCorner(direction: UIRectCorner.allCorners, cornerRadii: cornerRadii, borderWidth: 0, borderColor: UIColor.clear, backgroundColor: UIColor.clear)
    }
    
    func lg_roundCorner(direction: UIRectCorner, cornerRadii: CGFloat, borderWidth: CGFloat, borderColor: UIColor, backgroundColor: UIColor)  {
            if self.classForCoder == UIImageView.classForCoder() {
                LGCornerCutter.cuttingImageView(imageView: self as! UIImageView, direction: direction, cornerRadii: cornerRadii, borderWidth: borderWidth, borderColor: borderColor, backgroundColor: backgroundColor)
            }else{
                ...
                LGCornerCutter.cuttingView(view: self, direction: direction, cornerRadii: cornerRadii, borderWidth: borderWidth, borderColor: borderColor, backgroundColor: viewBackColor)
                }
        }
    
}

public class LGCornerCutter: NSObject {
